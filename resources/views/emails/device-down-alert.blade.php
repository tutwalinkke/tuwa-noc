...
<p style="margin:0; color:#991b1b; font-size:14px; font-weight:600;">DEVICE OFFLINE</p>
</td>
</tr>
</table>

<p style="margin:0 0 16px 0; color:#18181b; font-size:15px; line-height:1.5;">{{ $eventMessage }}</p>
...
<tr>
<td style="padding:12px 16px; border-bottom:1px solid #e4e4e7; color:#71717a; font-size:13px; width:120px;">Device</td>
...
<tr>
<td style="padding:12px 16px; @if($device->site) border-bottom:1px solid #e4e4e7; @endif color:#71717a; font-size:13px;">Type</td>
<td style="padding:12px 16px; @if($device->site) border-bottom:1px solid #e4e4e7; @endif color:#18181b; font-size:13px;">{{ ucfirst($device->type) }}</td>
</tr>
@if($device->site)
<tr>
<td style="padding:12px 16px; color:#71717a; font-size:13px;">Site</td>
<td style="padding:12px 16px; color:#18181b; font-size:13px;">{{ $device->site }}</td>
</tr>
@endif
</table>
